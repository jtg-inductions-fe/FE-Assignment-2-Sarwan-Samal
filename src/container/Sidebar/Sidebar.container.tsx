...
export const Sidebar = ({ items, open, onClose }: SideBarProps) => {
    ...
    const showSidebar = location.pathname === ROUTES.CORE.HOME;
        ...
        <SidebarWrapper>
            ...
            <Stack direction="row" justifyContent="center" gap={5}>
                <IconButton
                    ...
                    size="medium"
                    onClick={() => {
                        void navigate(ROUTES.UTILS.ADJUSTMENTS);
                        onClose();
                    }}
                ...
                <IconButton
                    ...
                    size="medium"
                    onClick={() => {
                        void navigate(ROUTES.UTILS.GLOBE);
                        onClose();
                    }}
                    aria-label="Globe"
                />
                <IconButton
                    ...
                    size="medium"
                    onClick={() => {
                        void navigate(ROUTES.UTILS.COG);
                        onClose();
                    }}
                    aria-label="Cog"
                />
